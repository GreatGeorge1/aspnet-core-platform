        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Professions_ProfessionId",
                        column: x => x.ProfessionId,
                        principalTable: "Professions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_Professions_ProfessionId",
                        column: x => x.ProfessionId,
                        principalTable: "Professions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _fileurls = table.Column<string>(nullable: true),
                    Version = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionContent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfessionContent_Professions_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Professions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StepContent_Steps_CoreId",
                        column: x => x.CoreId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSeenSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSeenSteps_Steps_StepId",
                        column: x => x.StepId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSeenSteps_UserProfessions_UserProfessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTests_Steps_TestId",
                        column: x => x.TestId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerContent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerContent_Answers_CoreId",
                        column: x => x.CoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    UserTestId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_ProfessionId",
                table: "Packages",
                column: "ProfessionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionContent_CoreId",
                table: "ProfessionContent",
                column: "CoreId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSeenSteps_StepId",
                table: "UserSeenSteps",
                column: "StepId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSeenSteps_UserProfessionId",
                table: "UserSeenSteps",
