...
namespace Platform.Professions
{
    ...
    public class ProfessionAppService : ApplicationService, IProfessionAppService
    {
        ...
        public ProfessionAppService(IRepository<Profession, long> professionRepository, IRepository<ProfessionTranslations, long> translationRepository, IRepository<Block, long> blockRepository)
        {
